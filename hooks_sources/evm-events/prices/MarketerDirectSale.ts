export const MarketerDirectSale = async (sale: any, event: any, sale_contract_type: any, prices: any, web3: Web3, height: number): Promise<void> => {
