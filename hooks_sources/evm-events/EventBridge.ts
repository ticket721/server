...
import { new_manager_bridge_action }    from './events/new_manager';
import { delete_manager_bridge_action } from './events/delete_manager';
...
export class EventBridge {
    ...
    private async address_check(by: string, to: string): Promise<{ db_by: any; db_to: any; }> {
        ...
        // Check by address
        if (db_by === null) {
            db_by = new this.address({address: by, admin: false, event_manager: false, event: false});
            try {
                await db_by.save();
            } catch (e) {
        ...
        // Check to address
        if (db_to === null) {
            db_to = new this.address({address: to, admin: false, event_manager: false, event: false});
            try {
                await db_to.save();
            } catch (e) {
    ...
    private async _feed(action: string, by: string, to: string, id: number, infos: any, block: number): Promise<void> {
        ...
        switch /* istanbul ignore next */ (action) {
            ...
            case /* istanbul ignore next */ 'mint':
                /* istanbul ignore next */ return await (mint_bridge_action.bind(this)(db_by, db_to, id, block, infos));
            case /* istanbul ignore next */ 'transfer':
                /* istanbul ignore next */ return await (transfer_bridge_action.bind(this)(db_by, db_to, id, block, infos));
            case /* istanbul ignore next */ 'event':
                /* istanbul ignore next */ return await (event_bridge_action.bind(this)(db_by, db_to, id, block, infos));
            case /* istanbul ignore next */ 'sale':
                /* istanbul ignore next */ return await (sale_bridge_action.bind(this)(db_by, db_to, id, block, infos));
            case /* istanbul ignore next */ 'buy':
                /* istanbul ignore next */ return await (buy_bridge_action.bind(this)(db_by, db_to, id, block, infos));
            case /* istanbul ignore next */ 'sale_close':
                /* istanbul ignore next */ return await (sale_close_bridge_action.bind(this)(db_by, db_to, id, block, infos));
            case /* istanbul ignore next */ 'new_admin':
                /* istanbul ignore next */ return await (new_admin_bridge_action.bind(this)(db_by, db_to, id, block, infos));
            case /* istanbul ignore next */ 'delete_admin':
                /* istanbul ignore next */ return await (delete_admin_bridge_action.bind(this)(db_by, db_to, id, block, infos));
            case /* istanbul ignore next */ 'new_manager':
                /* istanbul ignore next */ return await (new_manager_bridge_action.bind(this)(db_by, db_to, id, block, infos));
            case /* istanbul ignore next */ 'delete_manager': {
                /* istanbul ignore next */ return await (delete_manager_bridge_action.bind(this)(db_by, db_to, id, block, infos));
            }
