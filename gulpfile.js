...
const {setup, tsc_hooks, tsc_modules} = require('./tasks/setup');
const {config} = require('./tasks/config');
const {clean, remove_hooks} = require('./tasks/clean');
const {start} = require('./tasks/start');

exports['server:setup'] = series(requirements, portalize_requirements, setup, config, tsc_hooks, tsc_modules);
